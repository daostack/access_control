...
contract Protected {
    ...
    /* A collection of convinience methods for generating lock ids */
    function lockId(bytes32 _arg0, bytes32 _arg1) internal returns(bytes32) {
        return keccak256(abi.encodePacked(_arg0, _arg1));
    }
    function lockId(bytes32 _arg0, bytes32 _arg1, bytes32 _arg2) internal returns(bytes32) {
        return keccak256(abi.encodePacked(_arg0, _arg1, _arg2));
    }
    function lockId(bytes32 _arg0, bytes32 _arg1, bytes32 _arg2, bytes32 _arg3) internal returns(bytes32) {
        return keccak256(abi.encodePacked(_arg0, _arg1, _arg2, _arg3));
    }
    function lockId(bytes32 _arg0, bytes32 _arg1, bytes32 _arg2, bytes32 _arg3, bytes32 _arg4) internal returns(bytes32) {
